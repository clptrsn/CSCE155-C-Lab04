...
following URL: \url{https://github.com/clptrsn/CSCE155-C-Lab04}.
...
\begin{enumerate}
  ...
  \item Hand in your \mintinline{text}{sine.c}, \mintinline{text}{guessingGame.c}, and \mintinline{text}{primes.c} source file by pointing your browser to:
